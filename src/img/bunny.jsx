      ...
      <g transform="matrix(1.25,0,0,-1.25,0,47.5)" id="g10">
        <g id="g12">
          <g clipPath="url(#clipPath16)" id="g14">
            <g transform="translate(10,26)" id="g20">
              <path
                className="ear ear-outer ear-right"
                id="path22"
                style={{
                  fill: "#99aab5",
                  fillOpacity: 1,
            ...
            <g transform="translate(10.5498,25.2964)" id="g24">
              <path
                className="ear ear-inner ear-right"
                id="path26"
                style={{
                  fill: "#f4abba",
                  fillOpacity: 1,
            ...
            <g transform="translate(5.7886,24.625)" id="g28">
              <path
                className="ear ear-outer ear-left"
                id="path30"
                style={{
                  fill: "#99aab5",
                  fillOpacity: 1,
            ...
            <g transform="translate(6.5005,24.0859)" id="g32">
              <path
                className="ear ear-inner ear-left"
                id="path34"
                style={{
                  fill: "#f4abba",
                  fillOpacity: 1,
            ...
            <g transform="translate(37,8.5)" id="g36">
              <path
                className="tail"
                id="path38"
                style={{
            ...
            <g transform="translate(31.7334,5.2637)" id="g40">
              <path
                className="body"
                id="path42"
                style={{
            ...
            <g transform="translate(8,19)" id="g44">
              <path
                className="eye"
                id="path46"
                style={{
            ...
            <g transform="translate(3,16)" id="g48">
              <path
                className="nose"
                id="path50"
                style={{
