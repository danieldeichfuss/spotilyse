      ...
      <g transform="matrix(1.25,0,0,-1.25,0,47.5)" id="g10">
        <g id="g12">
          <g clip-path="url(#clipPath16)" id="g14">
            <g transform="translate(10,21.4395)" id="g20">
              <path
                class="ear ear-right"
                id="path22"
                style={{
            ...
            <g transform="translate(6.125,21.4395)" id="g24">
              <path
                class="ear ear-left"
                id="path26"
                style={{
            ...
            <g transform="translate(37,2.0645)" id="g28">
              <path
                class="body"
                id="path30"
                style={{
            ...
            <g transform="translate(11.9248,12.0645)" id="g32">
              <path
